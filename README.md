...
- Для корректной оценки качества выдач используется vintage/MOB-анализ: последние месяцы показывают низкий DPD30+ из-за незрелости кредитов, а не из-за однозначного улучшения качества портфеля.
